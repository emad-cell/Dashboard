...
@section('hero')
<x-hero-section title="Contact Us" subtitle="Constct"></x-hero-section>
                            ...
                            <form action="{{ route('front.message.store') }}" method="post">
                                ...
                                <div class="row g-3">
                                                                        @if (session('messageSuccess'))
                                                                            <div class="alert alert-primary">{{session('messageSuccess')}}</div>
                                                                        @endif
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            <label for="message">Message</label>
                                                        <x-input-error :messages="$errors->get('subscribe')" class="mt-2" />
                                        </div>
                                    </div>
                                    <div class="col-12">
